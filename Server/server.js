...
app.post("/predict", async (req, res) => {
  ...
  try {
    ...
    const inputArray = [
      inputData.Tenure, inputData.Matric, inputData.Degree, inputData.Diploma,
      inputData.Schoolquintile, inputData.Math, inputData.Mathlit,
      inputData.Additional_lang, inputData.Home_lang, inputData.Science,
      inputData.Female, inputData.Birthyear, inputData.Birthmonth,
      inputData.Geography_Suburb, inputData.Geography_Urban, inputData.Geography_nan,
      inputData.Province_Free_State, inputData.Province_Gauteng,
      inputData.Province_KwaZuluNatal, inputData.Province_Limpopo,
      inputData.Province_Mpumalanga, inputData.Province_North_West,
      inputData.Province_Northern_Cape, inputData.Province_Western_Cape,
    ...
    res.status(500).json({ error: "Prediction failed", details: error.toString() });
  }
});
...
app.post('/register', async (req, res) => {
  const { username, email, password, registration_date, role, permission} = req.body;
