...
// import Google from Create_Service;
...
function Visualisations() {
  ...
  //     const fileUrl = 'https://drive.google.com/uc?id=https://drive.google.com/file/d/1-P8Apec084SEc7x9MwX0PoS4cyxFEfo0/view?usp=drive_link';
  ...
  // import axios from 'axios';
    ...
    //   version: 'v3',
    //   auth: apiKey, // Use API key for public access, for private access, use OAuth 2.0 client ID
    // });

    // const uploadFile = async () => {
    //   try {
    //     // Replace with your file content and metadata
    //     const fileContent = 'testing testing';
    //     const fileName = 'example.txt';
    //     const mimeType = 'text/plain';

    //     // Create a FormData object for the file content
    ...
    //       {
    //         headers: {
    //           Authorization: `Bearer ${apiKey}`, // Use API key for public access, for private access, use OAuth 2.0 token
            ...
            <div className='card-container-accuracy' style={{ width: '1200px', height: '640px', overflow: 'auto' }}>
              <div className='card-container' style={{ marginLeft: 'auto', marginRight: 'auto' }}>
                <div className='card' style={{ width: '800px', height: '400px' }}>
                  ...
                  {/* <div><img src='https://drive.google.com/file/d/1-P8Apec084SEc7x9MwX0PoS4cyxFEfo0/view' alt="Logo" style={{height:'350px',width:'680px', marginLeft:'62px'}}/></div> */}
                  <iframe src="https://drive.google.com/file/d/1-P8Apec084SEc7x9MwX0PoS4cyxFEfo0/preview" width="680" height="345" allow="autoplay" style={{marginLeft:'62px'}}></iframe>
