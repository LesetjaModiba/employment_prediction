      ...
      <div className="layout">
        <div className="left-panel">
          ...
          <div className="menu-options">
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}><img src={visual} alt="visual" className="menu-icon" /><Link to="/visualisations" style={optionColor}>Visualisations</Link></div>
        ...
        <div className="right-panel">
          ...
          <div style={{ display: 'flex' }}>
            <div className='card-container-accuracy' style={{ width: '100%',maxWidth:'1000px', height: '640px', overflow: 'auto' }}>
              <div className='card-container' style={{ width:'100%', marginTop:'-70px'}}>
                <div style={{ marginBottom:'10px',width: '72%', height: '400px','display':'flex','justifyContent':'center','flexDirection':'column', marginLeft:'auto', marginRight:'auto' }}>
                  <div className='card-header'><p>{items.heading}</p></div>

                  <iframe src={fileUrl} width="99%"  height="345" allow="autoplay" style={{'marginLeft':'auto', 'marginRight':'auto'}}></iframe>
